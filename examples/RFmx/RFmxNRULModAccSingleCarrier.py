...
axs[0, 0].plot([symbol.real for symbol in puschDataConstellation], [symbol.imag for symbol in puschDataConstellation], "ro")
axs[0, 0].plot([symbol.real for symbol in puschDmrsConstellation], [symbol.imag for symbol in puschDmrsConstellation], "bo")
