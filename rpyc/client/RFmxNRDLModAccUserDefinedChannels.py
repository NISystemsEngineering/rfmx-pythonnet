...
waveform_file_name = 'NR_DL_FR2_100M_120k_256QAM.tdms'   # Name of the .tdms waveform to play
...
nr_auto_increment_cellid_enabled = True
nr_auto_resource_block_detection_enabled = True

nr_pdsch_modulation_type = NRMX.RFmxNRMXPdschModulationType.Qam256
nr_number_of_resource_block_clusters = 1
nr_pdsch_resource_block_offset = [0]
nr_pdsch_number_of_resource_blocks = [-1]
nr_pdsch_slot_allocation = "0-Last"
nr_pdsch_symbol_allocation = "0-Last"

nr_pdsch_dmrs_power_mode = NRMX.RFmxNRMXPuschDmrsPowerMode.CdmGroups
nr_pdsch_dmrs_power = 0.0
nr_pdsch_dmrs_configuration_type = NRMX.RFmxNRMXPuschDmrsConfigurationType.Type1
nr_pdsch_mapping_type = NRMX.RFmxNRMXPuschMappingType.TypeA
nr_pdsch_dmrs_type_a_position = 2
nr_pdsch_dmrs_duration = NRMX.RFmxNRMXPuschDmrsDuration.SingleSymbol
nr_pdsch_dmrs_additional_positions = 0
...
nr.SetAutoIncrementCellIDEnabled("", nr_auto_increment_cellid_enabled)

nr.ComponentCarrier.SetPdschModulationType("", nr_pdsch_modulation_type)
nr.ComponentCarrier.SetPdschSlotAllocation("", nr_pdsch_slot_allocation)
nr.ComponentCarrier.SetPdschSymbolAllocation("", nr_pdsch_symbol_allocation)

nr.ComponentCarrier.SetPdschNumberOfResourceBlockClusters("", nr_number_of_resource_block_clusters)
...
nr_pdsch_string = NRMX.RFmxNRMX.BuildPdschString(nr_user_string, 0)
for i in range(nr_number_of_resource_block_clusters):
    nr_pdsch_cluster_string = NRMX.RFmxNRMX.BuildPdschClusterString(nr_pdsch_string, i)
    nr.ComponentCarrier.SetPdschResourceBlockOffset(nr_pdsch_cluster_string, nr_pdsch_resource_block_offset[i])
    nr.ComponentCarrier.SetPdschNumberOfResourceBlocks(nr_pdsch_cluster_string, nr_pdsch_number_of_resource_blocks[i])

nr.ComponentCarrier.SetPdschDmrsPowerMode("", nr_pdsch_dmrs_power_mode)
nr.ComponentCarrier.SetPdschDmrsPower("", nr_pdsch_dmrs_power)
nr.ComponentCarrier.SetPdschDmrsConfigurationType("", nr_pdsch_dmrs_configuration_type)
nr.ComponentCarrier.SetPdschMappingType("", nr_pdsch_mapping_type)
nr.ComponentCarrier.SetPdschDmrsTypeAPosition("", nr_pdsch_dmrs_type_a_position)
nr.ComponentCarrier.SetPdschDmrsDuration("", nr_pdsch_dmrs_duration)
nr.ComponentCarrier.SetPdschDmrsAdditionalPositions("", nr_pdsch_dmrs_additional_positions)
